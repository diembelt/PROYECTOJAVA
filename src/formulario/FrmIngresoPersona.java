...
public class FrmIngresoPersona extends javax.swing.JFrame {
    ...
    private boolean formularioValido(){
        ...
        try{
            ...
            if(Validador.validarDuplicidad(registros,tfCedula.getText())){
                JOptionPane.showMessageDialog(this, "La cédula se encuentra registrada","Validación",JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }catch(Exception e){
            return false;
    ...
    private void bIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bIngresarActionPerformed
        ...
        if(formularioValido()){
            ...
            if(Archivo.insertar_registro(p)){
                JOptionPane.showMessageDialog(this,"Se ingresó correctamente la persona", "Ingreso",JOptionPane.INFORMATION_MESSAGE);            
                limpiarFormulario();
            }else{
